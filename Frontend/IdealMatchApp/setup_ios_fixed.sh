...
if [ ! -d "node_modules" ]; then
    ...
    echo "✅ node_modules 디렉토리 확인됨"
fi

# 5. react-native 패키지 확인
echo ""
echo "📱 5단계: react-native 패키지 확인"
if [ ! -d "node_modules/react-native" ]; then
    echo "❌ react-native 패키지가 설치되지 않았습니다."
    echo "   npm install을 다시 실행해주세요."
    exit 1
fi
echo "✅ react-native 패키지 확인됨"

# 6. iOS 디렉토리로 이동
echo ""
echo "📱 6단계: iOS 프로젝트 설정"
cd ios
